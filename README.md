...
[Оценка маркетинговых компаний с помощью метрик](https://github.com/IvanoVladimir/Marketing_metrics 'Ссылка на проект') | Оценка результатов двух прошедших рекламных компаний с помощью метрик окупаемости инвестиций, средней стоимости заказа, удеражния пользователей, накопительной средней выручки на платящего пользователя и затрат на привлечение одного покупателя;их расчёт, построение визуализации и дашборда | Python; Jupyter Notebook; SQL - PostgreSQL, Redash
